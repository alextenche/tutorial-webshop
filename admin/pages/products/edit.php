			...
			if($objValid->isValid()){
				...
				if($objCatalogue->updateProduct($objValid->_post, $id)){
					...
					if($objUpload->upload(CATALOGUE_PATH)){
						...
						Helper::redirect('/ecommerce/admin'.Url::getCurrentUrl(array('action','id')).'&action=edited-no-upload');
					}
				} else {
	...
	<table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
		...
		<tr>
			...
			<td>
				...
				<textarea name="description" id="description" cols="" rows="" class="tar_fixed">
				<?php echo $objForm->stickyText('description', $product['description']); ?>
				</textarea>
			</td>
		</tr>

...
<body>
	<div id="wrapper">
		...
		<div style="width:50%;float:left">
			...
			<?php $country = $objCountry->getCountry($user['country']);
				echo $country['name']; ?>
			</p>
		</div>
		...
		<tr>
			<td><?php $product = $objCatalogue->getProduct($item['product']);
	...
	<p><a href="#" onclick="window.print(); return false;">Print this invoice</p>

...
if(empty($cat)) {
					...
					<?php foreach($rows as $row) : ?>
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<img src="<?php echo $image; ?>" alt="<?php echo Helper::encodeHtml($row['name'], 1); ?>" width="<?php echo $width; ?>" /></a>
							</div><!-- end col-md-3 -->
	...
	} // end else if(empty($category))

} // end else if(empty($cat))